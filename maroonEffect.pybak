def maroonEffect(image):
  ...
  #it turns out that if you use a darker color first, it kind of looks 
  #similar to grayScale, but if you use a darker color second, 
  #it looks similar to negative
